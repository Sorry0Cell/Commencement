...
class YT8MFrameFeatureReader(BaseReader):
  ...
  def do_pca(self, input,max_quantized_value=2.0,
    ...
    res_fea = utils.quantize(res_fea_pca, max_quantized_value=max_quantized_value, min_quantized_value=min_quantized_value)
    res_fea = utils.Dequantize(res_fea,max_quantized_value=max_quantized_value,min_quantized_value=min_quantized_value)
